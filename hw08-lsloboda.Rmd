...
I setup an account on shinyapp.io and linked it with my github account. I installed the rsConnect() package, loaded the library, then used deployApp() to create the web app, found [here](https://lsloboda.shinyapps.io/bcl-lsloboda/)!
